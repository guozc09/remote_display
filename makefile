...
pkgdatadir = $(datadir)/remotedisplay
pkgincludedir = $(includedir)/remotedisplay
pkglibdir = $(libdir)/remotedisplay
pkglibexecdir = $(libexecdir)/remotedisplay
...
PRE_UNINSTALL = :
POST_UNINSTALL = :
noinst_PROGRAMS = remotedisplay$(EXEEXT)
subdir = .
...
remotedisplay_LINK = $(CXXLD) $(AM_CXXFLAGS) $(CXXFLAGS) \
	$(remotedisplay_LDFLAGS) $(LDFLAGS) -o $@
AM_V_P = $(am__v_P_$(V))
...
am__v_CXXLD_1 = 
SOURCES = $(remotedisplay_SOURCES)
DIST_SOURCES = $(remotedisplay_SOURCES)
...
CXXFLAGS = -g -O2
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H -D_GNU_SOURCE -std=c++11 -Wall
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
PACKAGE_BUGREPORT = guozc09@163.com
PACKAGE_NAME = remotedisplay
PACKAGE_STRING = remotedisplay 1.0
PACKAGE_TARNAME = remotedisplay
PACKAGE_URL = 
PACKAGE_VERSION = 1.0
PATH_SEPARATOR = :
RANLIB = ranlib
...
STRIP = 
VERSION = 1.0
abs_builddir = /home/zhcguo/LinuxMount/remote_display
abs_srcdir = /home/zhcguo/LinuxMount/remote_display
abs_top_builddir = /home/zhcguo/LinuxMount/remote_display
abs_top_srcdir = /home/zhcguo/LinuxMount/remote_display
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/zhcguo/LinuxMount/remote_display/install-sh
...
remotedisplay$(EXEEXT): $(remotedisplay_OBJECTS) $(remotedisplay_DEPENDENCIES) $(EXTRA_remotedisplay_DEPENDENCIES) 
	...
	$(AM_V_CXXLD)$(remotedisplay_LINK) $(remotedisplay_OBJECTS) $(remotedisplay_LDADD) $(LIBS)
